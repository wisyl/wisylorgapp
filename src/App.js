...
import { faBell, faUser } from '@fortawesome/free-solid-svg-icons'; // add fontawesome icons here and below in libary.add
...
import { DateRangePicker, SingleDatePicker, DayPickerRangeController } from 'react-dates'; //datepicker
import 'react-dates/lib/css/_datepicker.css'; //datepicker
    ...
    <Header />
			<div className="site-container">
												...
												<Col md={{ size: 'auto', offset: 1 }}>
													<FormGroup>
														...
														<FormText color="muted">
															Image requirements would go here.<br /> Q: Should we use Cloudinary?
														</FormText>
													</FormGroup>
												</Col>
											</Row>
													...
													<Form className="mt-5">
														<Container>
															<Row>
																...
																<Col>
																	<Label for="exampleEmail">Preview</Label><br />
												...
												<Col md="6">
													<FormGroup tag="fieldset">
														<Label>
															...
															Send Now (are you sure you want to push the red button)
														</Label>
													</FormGroup>
													<FormGroup>
														<Label>
				...
				<Container className="mt-5">
					<Row>
						<Col>
							<Button color="primary" size="lg">Send Message to 164 Recipients</Button>
						</Col>
					</Row>
				</Container>
